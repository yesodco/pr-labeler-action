    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (labelsToAdd.length > 0) {
                yield octokit.issues.addLabels(Object.assign(Object.assign({}, context.repo), { number: context.payload.pull_request.number, labels: labelsToAdd }));
            }
        }
        catch (error) {
...
function getLabelsToAdd(config, branchName) {
    return Object.entries(config).reduce((labels, [label, patterns]) => {
        if (Array.isArray(patterns)
            ? patterns.some(pattern => matcher_1.default.isMatch(branchName, pattern))
            : matcher_1.default.isMatch(branchName, patterns)) {
            labels.push(label);
        }
        return labels;
    }, []);
